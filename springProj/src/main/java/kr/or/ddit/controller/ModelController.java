...
public class ModelController {
	...
	//2. 모델을 통한 데이터 전달
	// Model 객체를통해서 다양한 데이터를 뷰(View, jsp)에 전달할 수 있음
	...
	//3. 골뱅이 ModelAttribute 애너테이션
	// : 전달받은 매개변수를 강제로 Model에 담아서 전달할 때 사용
	// 요청 URI : /model/registerForm
	...
	요청방식 : post
	 */
	//매개변수로 선언 후 forwarding시 기본적으로 데이터 전달이 안됨
	...
	요청방식 : post
	 */
	//자바빈즈 규칙(멤버변수, 기본생성자,getter/setter메서드)
