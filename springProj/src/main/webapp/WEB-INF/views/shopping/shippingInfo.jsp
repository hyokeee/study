...
$(function(){
	$('#autoFill').on('click',function(){
		...
		$("input[name='zipCode']").val("12-345");
		$("input[name='addressName']").val("대전 중구 오류동");
	});
});
...
<body>
	...
	<!-- /////////////////////////////// 배송 정보 시작 //////////////////////////////// -->
	<!-- /shippingInfo.jsp?cartId=0847CF4B0C1DF3A765C2BE839FD8D5BE -->
	<div class="container">
		<form action="/shopping/processShippingInfo" class="form-horizontal" method="post">
