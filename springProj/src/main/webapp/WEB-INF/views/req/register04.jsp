...
<form action="/req/register0402" method="post">
   ...
   <p>
          자동차 : <select name="cars" multiple>
             ...
             <option value="ferrari296GTB" selected>Ferrari296GTB</option>
             <option value=""></option>
          </select>
   </p>
   <p>
   ...
   <p>
          우편번호 :
      <input type="text" name="addressVO.zonecode" placeholder="우편번호" readonly/>
   ...
   <p>
      <input type="submit" value="register0402"/>
   </p>
   <script>
   $(function(){
