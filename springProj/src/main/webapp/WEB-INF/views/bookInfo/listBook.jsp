	...
	<div class="card-body">
		<div class="table-responsive">
			<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
				<!--  action="/bookInfo/listBook" method="get" 생략 해도 같은 결과 -->
				<!-- 
				...
				<div class="row">
					<div class="col-sm-12 col-md-5">
						...
						<div class="dataTables_info" id="dataTable_info" role="status"
							aria-live="polite">Showing ${(data.currentPage-1)*data.size +1 } to ${data.currentPage*data.size} of ${data.total } entries</div>
					</div>
						...
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
								...
								<li class='paginate_button page-item
									...
									<a href="/bookInfo/listBook?currentPage=${pNo }&size=${data.size}"
