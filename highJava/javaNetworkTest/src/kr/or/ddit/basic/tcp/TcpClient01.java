...
public class TcpClient01 {
	public static void main(String[] args) throws IOException{
		/*
		 - 현재 자신의 컴퓨터를 나타내는 방법
		 1) 원래의 IP주소 : 예) 192.168.142.15
		 2) 지정된 IP주소 : 127.0.0.1 (자신 컴퓨터를 의미함)
		 3) 원래의 컴퓨터 이름 : 예) DESKTOP-MQCGD91
		 4) 지정된 컴퓨터 이름 : localhost (자신 컴퓨터를 의미함)
		...
		Socket socket = new Socket("192.168.142.15",7777);
