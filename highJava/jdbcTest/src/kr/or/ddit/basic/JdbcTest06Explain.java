...
*/
public class JdbcTest06Explain {
	private Scanner scan = new Scanner(System.in);
	
	public static void main(String[] args) {
		new JdbcTest06Explain().memberStart();
	}
	...
	private void updateMember2() {
		...
		try {
			...
			if(cnt>0) {
				System.out.println(memId+" 회원 " + updateTitle + " 수정 성공!");
			} else {
				System.out.println(memId+" 회원 " + updateTitle + " 수정 실패!");
			}
...
//			break;	
//		}
//		System.out.println("수정할 " + newCol + "값을 입력하세요");
//		System.out.print("입력 >> ");
//		scan.nextLine();		//버퍼 비우기
...
//		try {
//			conn = DBUtil.getConnection();
//			String sql = "update mymember set " + newCol + " = '" +newVal + "' where mem_id = ?";
//			pstmt = conn.prepareStatement(sql);
//			pstmt.setString(1, memId);
//			
//			int cnt = pstmt.executeUpdate();
//			if(cnt>0) {
//				System.out.println(memId + "회원 " +newCol+" 정보 수정 성공!!!");
//			} else {
//				System.out.println(memId + "회원 " +newCol+" 정보 수정 실패!!!");
//			}
//		} catch (SQLException e) {
//			// TODO: handle exception
//		}
//	}
	...
	//회원ID를 매개변수로 받아서 해당 회원의 개수를 반화하는 메서드
