...
public class FileIOTest04 {
	public static void main(String[] args) {
		...
		//System.in	 ==> 콘솔(표준입출력장치)의 입력 장치와 연결된 바이트기반의 입력용 스트림 객체
		//System.out ==> 콘솔(표준입출력장치)의 출력 장치와 연결된 바이트기반의 출력용 스트림 객체
		try {
			
			/*	read()는 한글자씩 받음 ==> 한글(2byte) 받으면 글씨가 깨짐
			 * System.out.print("한 문자 입력 >> "); int c = System.in.read();
			 * 
