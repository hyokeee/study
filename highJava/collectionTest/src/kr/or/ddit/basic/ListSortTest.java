...
/*
		 ...
		 Comparable은 Collection에 추가되는 데이터 자체에 정렬 기준을 넣고 싶을 때 구현하는 인터페이스이다.(내부 정렬 기준)
		 Comparator는 외부에 별도로 정렬 기준을 구현하고 싶을 때 구현하는 인터페이스이다. (외부 정렬 기준)
...
public class ListSortTest {
	...
	// 외부 정렬 기준을 적용해서 정렬하기(내림차순)
	Collections.sort(list,new Desc());
	System.out.println("내부 정렬 기준 정렬 후 : " + list);
