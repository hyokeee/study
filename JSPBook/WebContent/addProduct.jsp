...
<body>
	...
	<div class="container">
		<div class="text-right">
			...
			<a href="?language=ko">Korean</a>|<a href="/addProduct.jsp?language=en">English</a>
			<!-- 로그아웃 페이지 호출 -->
		...
		<form name="newProduct" action="processAddProduct.jsp"
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="radio" id="condition1" name="condition" value="New"/><label for="condition1"><fmt:message key="condition_New"/></label>
					<input type="radio" id="condition2" name="condition" value="Old"/><label for="condition2"><fmt:message key="condition_Old"/></label>
					<input type="radio" id="condition3" name="condition" value="Refurbished"/><label for="condition3"><fmt:message key="condition_Refurbished"/></label>
				</div>
			</div>
			<!-- 상품 이미지 -->
			<div class="form-group row">
