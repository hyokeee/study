...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">$<%= (i+1)*20 + ",000" %></div>
                                        </div>
                                        <div class="col-auto">
                                        	<% 
                                        	   String a = "";
                                        	...
                                        	%>
                                            <i class="fas <%=a %> fa-2x text-gray-300"></i>                                  	
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="/sbdamin2/vendor/jquery/jquery.min.js"></script>
    <script src="/sbdamin2/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="/sbdamin2/vendor/jquery-easing/jquery.easing.min.js"></script>
